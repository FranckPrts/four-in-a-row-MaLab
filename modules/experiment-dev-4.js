...
export function set_showTutorial(ShowTutorial){
...
export function create_timeline(timeline){
    ...
    var free_play_instructions = {
        ...
        '<img width="80%" height="auto" src="https://github.com/FranckPrts/four-in-a-row-MaLab/blob/main/static/instructions1.png"></img>',
        'If you get 4 pieces in a row, you win!<br/><br/>' +
        '<img width="80%" height="auto" src="https://github.com/FranckPrts/four-in-a-row-MaLab/blob/main/static/instructions2.png"></img>',
        'You can connect your 4 pieces in any direction: horizontally, vertically or diagonally.<br/><br/>' +
        '<img width="80%" height="auto" src="https://github.com/FranckPrts/four-in-a-row-MaLab/blob/main/static/instructions3.png"></img>',
        ...
        '<img width="80%" height="auto" src="https://github.com/FranckPrts/four-in-a-row-MaLab/blob/main/static/instructions4.png"></img>',
        ...
        'The experiment consists of ${this.parameters.numberOfTrial} games.'
        ],
    ...
    var submit_block = {
        ...
        stimulus: function(){
            return `<div> 
                        <p>
                            Thank you for taking part in this experiment!<br/>
        ...
        stimuli: [" "],
        choices: ['Submit your data'],
        on_load: function() {}
    }
    // var submit_block = { //////////////////////OLD SUBMITION BLOCK
