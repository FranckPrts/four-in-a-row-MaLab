    ...
    class FourInARow {
        ...
        update_top(){
            if (this.game_result == "win"){
                ...
                if (this.free_play){
                    this.top.innerHTML = `You won and got $${p} bonus reward!`;
                } else{
                ...
                this.top.innerHTML = `${this.turn} to move. Win in ${this.length} moves`;//, Puzzle ${this.game_index}
            }
        }
        timer(time){
        ...
        trial(display_element, trial){
            ...
            <h1 id='top'>${this.turn} to move</h1>
            <div id="container">
